...
<div class="wrapper">
    <header class="app-header animated fadeInDownBig <?php echo $dark_header ? 'header-bg-dark' : ''; ?>"  id="app-header"> <!-- Option dark background: .header-bg-dark (for page no hero)-->
        <div class="container">
                ...
                <div class="main-navbar">
                    ...
                    <div id="menu-primary">
                        <ul class="nav nav-pills" itemscope="" itemtype="http://www.schema.org/SiteNavigationElement">
                            <li id="menu-item-255" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-255 nav-item animated-item <?php echo is_front_page() ? 'active' : ''; ?>">
                            ...
                            foreach ($items as $key => $item){
                                ...
                                ?>
                                <li id="menu-item-255" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-255 nav-item animated-item <?php echo is_current_url($menu_item->url) ? 'active' : ''; ?>">
                                    <div class="group d-flex align-items-center" data-wow-offset="10" data-wow-delay="0.2s"><!-- wows -->
                                                ...
                                                <?php foreach ($sub_menu_items as $sub_menu_item){
                                                    ...
                                                    <?php foreach ($sub_menu_item as $item){
                                                        ...
                                                        <?php if ($item['have_child'] || $under_line): ?>
                                                            <div class="sub-menu-mobile__item " data-wow-offset="10" data-wow-delay="0.4s">
                    ...
                    foreach ($items as $key => $item):
                        ...
                        <?php foreach ($sub_menu_items as $sub_menu_item):?>
                            <div id="<?php echo $sub_menu_item['key_random']; ?>" class="menu-child nav nav-pill">
                                <div>
                                    <div class="back-menu-mobile d-flex align-items-center animated-item" >
                                    ...
                                    <div class="sub-menu-group">
                                        <a href="<?php echo $sub_menu_item['item']->url; ?>" class="sub-heading animated-item">
                                            ...
                                            <div class="d-flex gap-4">
                                                <div>
                                                    ...
                                                    foreach ($sub_menu_item['childs'] as $item):
                                                        $delay += 0.2;
                                                        ?>
                                                        <div class="sub-link text-dusk mb-3 animated-item">
                    ...
                    <?php else: ?>
                        <div id="<?php echo $item['key_random']; ?>" class="menu-child nav nav-pill">
                            <div>
                                ...
                                <div class="sub-menu-group">
                                    <a href="<?php echo $menu_item->url; ?>" class="sub-heading woww fadeInRight">
