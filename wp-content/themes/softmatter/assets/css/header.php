...
<div class="wrapper">
    <header class="app-header fadeInDownBig <?php echo $dark_header ? 'header-bg-dark' : ''; ?>"  id="app-header"> <!-- Option dark background: .header-bg-dark (for page no hero)-->
        <div class="container">
                    ...
                    <div id="menu-primary">
                        <ul class="nav nav-pills" itemscope="" itemtype="http://www.schema.org/SiteNavigationElement">
                            <li id="menu-item-255" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-255 nav-item <?php echo is_front_page() ? 'active' : ''; ?>">
                                <div class="group d-flex align-items-center fadeInRight wow" data-wow-offset="10" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInRight;">
                    ...
                    <?php else: ?>
                        <div id="<?php echo $item['key_random']; ?>" class="menu-child nav nav-pill">
                            <div>
                                ...
                                <div class="sub-menu-group">
                                    <a href="#" class="sub-heading woww fadeInRight" data-wow-offset="10" data-wow-delay="0.4s">
