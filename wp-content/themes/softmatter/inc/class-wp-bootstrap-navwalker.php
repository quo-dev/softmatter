...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = null ) {
			...
			$invest_widget = get_field('invest_widget', 'option');
			if(isset($invest_widget['show_in_the_sub_menu']) &&  $invest_widget['show_in_the_sub_menu'] == true) {
				$widget = "<div class='mega-menu__box hide-sm'>
				<div class='mega-menu__box-iner'>
				  <h1>". $invest_widget['heading'] ."</h1>
				  <a class='btn btn-outline-dark btn-outline-dark-sage-bg normal' href='". $invest_widget['button']['url'] ."' target='". $invest_widget['button']['target'] ."'>". $invest_widget['button']['title'] ."</a>
				</div>
			  </div>";
			}
			if($depth === 1){
				...
				$output .= "{$n}{$indent}<div class='mega-menu'><div class='d-flex container'>$widget<ul$class_names $labelledby>{$n}";
			}
		}
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			$extra_class = get_field('hide_on_mobile', $item)?" hide-xs":"";
			$extra_class .= get_field('hide_on_desktop', $item)?" show-xs":"";
			$classes[] = 'menu-item-' . $item->ID;
			$classes[] = 'nav-item '. $extra_class;
