          ...
          <div class="col-lg-6 d-flex align-items-center">
            <div class="our-stories__right story">
                ...
                <div class="story-item" style="background-image: url('<?php echo $item['background_image'];?>')">
                    <div>
                        <?php if ($item['title']): ?>
                        <div class="story-item__text asnimated-item wow fadeInRightBig" data-wow-duration="0.62s" data-wow-offset="10">
                            <?php echo $item['title']; ?>
                        </div>
                        <?php endif; ?>
                        <?php if ($item['sub_title']): ?>
                        <div class="story-item__author asnimated-item wow fadeInRightBig"  data-wow-duration="0.78s" data-wow-offset="10">
                            <?php echo $item['sub_title']; ?>
                        </div>
                        <?php endif; ?>
                        <?php if ($item['content']): ?>
                        <div class="story-item__bottom asnimated-item wow fadeInRightBig" data-wow-duration="0.94s" data-wow-offset="10">
