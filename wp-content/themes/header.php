...
global $woocommerce, $header_choice;
$totalCartItems = $woocommerce->cart->cart_contents_count;
$items = $woocommerce->cart->get_cart();
$woocommerce_menu = get_field('woocommerce_menu');
$dark_header = get_field('dark_header') ?: false;
if ($header_choice == 'header_dark') {
    $dark_header = true;
}
?>
<body <?php body_class($body_class); ?>>
<div class="wrapper">
    <header class="app-header wow fadeInDownBig <?php echo $dark_header ? 'header-bg-dark' : ''; ?>"  id="app-header"> <!-- Option dark background: .header-bg-dark (for page no hero)-->
        <div class="container">
            <div class="d-flex flex-wrap align-items-center py-sm-5 top-header">
                ...
                <div class="main-navbar">
                    ...
                    <div id="menu-primary">
                        <ul class="nav nav-pills" itemscope="" itemtype="http://www.schema.org/SiteNavigationElement">
                            <li id="menu-item-255" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-255 nav-item <?php echo is_front_page() ? 'active' : ''; ?>">
                                <div class="group d-flex align-items-center fadeInRight woww" data-wow-offset="10" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInRight;">
                                    <a itemprop="url" class="nav-link open-child-menu d-lg-none" href="<?php echo get_home_url(); ?>" >
                            ...
                            foreach ($items as $key => $item){
                                ...
                                ?>
                                <li id="menu-item-255" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-255 nav-item <?php echo is_current_url($menu_item->url) ? 'active' : ''; ?>">
                                    <div class="group d-flex align-items-center wowss fadeInRight" data-wow-offset="10" data-wow-delay="0.2s"><!-- wows -->
                                        <a itemprop="url" class="nav-link <?php echo $no_child_url ? 'open-child-menu d-none d-lg-block' : 'wowss fadeInRight'; ?>" href="<?php echo $menu_item->url; ?>">
                                                    ...
                                                    foreach ($sub_menu_items as $sub_menu_item){
                                                        ...
                                                        <div>
                                                            ...
                                                            foreach ($sub_menu_item as $item){
                                                                ...
                                                                ?>
                                                                <div class="sub-menu-group <?php echo is_current_url($item_sub['item']->url) ? 'active' : ''; ?>">
                                                                                ...
                                                                                foreach ($item_sub_array as $item_sub_child):
                                                                                    ...
                                                                                    <div>
                                                                                        <?php foreach ($item_sub_child as $child): ?>
                                                                                            <div class="sub-link text-dusk mb-3 <?php echo is_current_url($child['item']->url) ? 'active' : ''; ?>">
                                                ...
                                                <?php foreach ($sub_menu_items as $sub_menu_item){
                                                    ...
                                                    <?php foreach ($sub_menu_item as $item){
                                                        ...
                                                        <?php if ($item['have_child'] || $under_line): ?>
                                                            <div class="sub-menu-mobile__item wowss fadeInRight" data-wow-offset="10" data-wow-delay="0.4s">
                    ...
                    foreach ($items as $key => $item):
                        ...
                        <?php foreach ($sub_menu_items as $sub_menu_item):?>
                            <div id="<?php echo $sub_menu_item['key_random']; ?>" class="menu-child nav nav-pill">
                                <div>
                                    <div class="back-menu-mobile d-flex align-items-center woww fadeInRight" data-wow-offset="10" data-wow-delay="0.2s" >
                                    ...
                                    <div class="sub-menu-group">
                                        <a href="<?php echo $sub_menu_item['item']->url; ?>" class="sub-heading woww fadeInRight" data-wow-offset="10" data-wow-delay="0.4s">
                                            ...
                                            <div class="d-flex gap-4">
                                                <div>
                                                    ...
                                                    foreach ($sub_menu_item['childs'] as $item):
                                                        $delay += 0.2;
                                                        ?>
                                                        <div class="sub-link text-dusk mb-3 woww fadeInRight" data-wow-offset="10" data-wow-delay="<?php echo $delay;?>">
                    ...
                    <?php else: ?>
                        <div id="<?php echo $item['key_random']; ?>" class="menu-child nav nav-pill">
                            <div>
                                ...
                                <div class="sub-menu-group">
                                    <a href="<?php echo $menu_item->url; ?>" class="sub-heading woww fadeInRight" data-wow-offset="10" data-wow-delay="0.4s">
                ...
                <?php endif; ?>
                <form class="d-none form-search mx-1" action="<?php echo get_home_url(); ?>" method="get">
                    <div class="position-relative">
                        <input name="s" class="form-control form-search__input" type="text" />
